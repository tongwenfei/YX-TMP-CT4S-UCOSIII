...
#define SET_LCD_LED()	GPIO_SetBits(GPIOC,GPIO_Pin_11)
#define CLR_LCD_LED()	GPIO_ResetBits(GPIOC,GPIO_Pin_11)

#define SET_LCD_RST()	GPIO_SetBits(GPIOD,GPIO_Pin_7)
#define CLR_LCD_RST()	GPIO_ResetBits(GPIOD,GPIO_Pin_7)

#define SET_LCD_WR()	GPIO_SetBits(GPIOB,GPIO_Pin_8)
#define CLR_LCD_WR()	GPIO_ResetBits(GPIOB,GPIO_Pin_8)

#define SET_LCD_RD()	GPIO_SetBits(GPIOB,GPIO_Pin_7)
#define CLR_LCD_RD()	GPIO_ResetBits(GPIOB,GPIO_Pin_7)

#define SET_LCD_CS()	GPIO_SetBits(GPIOB,GPIO_Pin_6)
#define CLR_LCD_CS()	GPIO_ResetBits(GPIOB,GPIO_Pin_6)

#define SET_LCD_A1()	GPIO_SetBits(GPIOB,GPIO_Pin_5)
#define CLR_LCD_A1()	GPIO_ResetBits(GPIOB,GPIO_Pin_5)		//sunlis:selecting lcd register
